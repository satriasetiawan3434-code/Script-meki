-- ==========================================
-- KEY SYSTEM - MEKI GANTENG (UPDATED)
-- ==========================================
...
local function createKeyGUI()
    ...
    frame.Size = UDim2.new(0, 350, 0, 260)  -- Lebih tinggi buat loading
    ...
    textBox.Position = UDim2.new(0.5, -110, 0.25, 0)
    ...
    submitBtn.Position = UDim2.new(0.5, -60, 0.50, 0)
    ...
    getKeyBtn.Position = UDim2.new(0.5, -60, 0.70, 0)
    ...
    getKeyBtn.MouseButton1Click:Connect(function()
        ...
        if success then
            statusLabel.Text = "✅ Link copied sukses!"
    ...
    loadingLabel.Text = ""
    loadingLabel.TextColor3 = Color3.fromRGB(0, 200, 255)
    ...
    statusLabel.Position = UDim2.new(0, 0, 0.40, 0)
    ...
    return screenGui, textBox, submitBtn, statusLabel, loadingLabel
end

local gui, textBox, submitBtn, statusLabel, loadingLabel = createKeyGUI()

-- Fungsi validasi dengan loading
local function validate(input)
    if string.lower(input) == validKey then
        -- Sembunyikan semua elemen kecuali loading
        ...
        loadingLabel.Text = "Meki Scripter..."
        ...
        task.spawn(function()
            ...
            while loadingLabel.Visible do
                dots = (dots % 3) + 1
                loadingLabel.Text = "Meki Scripter" .. string.rep(".", dots)
                task.wait(0.3)
            end
        end)
        ...
        -- Sembunyikan loading dan destroy GUI
        loadingLabel.Visible = false
        keyVerified = true
        gui:Destroy()
        return true
...
local Window = Library:CreateWindow({
	Title = "meki hub",
	Footer = "Mine a Mountain | Made by meki scripter",
	AutoShow = true,
	NotifySide = "Right",
